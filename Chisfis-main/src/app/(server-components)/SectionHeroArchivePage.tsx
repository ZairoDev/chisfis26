...
const SectionHeroArchivePage: FC<SectionHeroArchivePageProps> = ({
  ...
  const greecePropertyCount = localStorage.getItem('greeceTotalProperties')


  const searchParams = useSearchParams();
  const country: string = searchParams.get("country") || "Greece";
  ...
  useEffect(() => {
    ...
    // console.log('context: ', typeof context, Array.isArray(context), context);
    let countryCount = 0;
          ...
          <div className="flex items-center text-base md:text-lg text-neutral-500 dark:text-neutral-400">
            ...
            {listingType ? (
              ...
              <>
                ...
                <span className="ml-2.5">{countryPropertyCount} Properties</span>
              </>
            )}
          </div>
        </div>

  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="font-semibold text-4xl mt-5">Benfits of Vacation Saga</h2>
        ...
        <ul className="space-y-10 mt-16">
          <li className="space-y-4">
            ...
            <span className="block mt-5 text-neutral-500 dark:text-neutral-400">
              You can advertise your rental with no commision
              costs
            </span>
          </li>
          <li className="space-y-4">
            ...
            <span className="block text-xl font-semibold">
              Reach millions with Vacation Saga
            </span>
            <span className="block mt-5 text-neutral-500 dark:text-neutral-400">
          ...
          <li className="space-y-4">
            ...
            <span className="block mt-5 text-neutral-500 dark:text-neutral-400">
              ...
              bookings and payments online all directly to your bank account
            </span>
          </li>
        </ul>
      </div>
